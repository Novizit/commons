...
import static com.novizit.constant.ErrorMessage.JWT_TOKEN_EXPIRED;
...
public class JwtProvider {
    ...
    @Value("${jwt.secret:novizitnovizitnovizitnovizitnovizit@202320232023}")
